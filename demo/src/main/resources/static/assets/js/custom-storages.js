...
/* Pagination */
	...
	var url = HOST_URL + "/stockman/storagers?currentPage=";
	$.ajax({
		url: HOST_URL + "/stockman/storagers/",
		type: "GET",
...
/* Pagination */
	$.ajax({
		url: HOST_URL + "/stockman/storagers?currentPage="+currentPage,
		type: "GET",
		success:function(data) {
			data = data.content;
			var counter = 0;
...
/*--------------------------Status Update--------------------------*/
			    $('.statusUpdate').click(function (event) {
			        ...
			        var statusUpdate = ($(this).is(':checked')) ? true : false;
					        ...
					        $.ajax({
					        	url: HOST_URL + "/stockman/storagerStatus/"+id,
								type: "PUT",
					            data: ser_data,
...
/*--------------------------SubCategory Delete--------------------------*/
			...
			function subCategoryDelete(silinecekId){
				$(function() {
					...
					Swal.fire({
					title: "Depoyu silmek istediğinizden emin misiniz?",
					...
					if (result.value) {
						$.ajax({
						url: HOST_URL + "/stockman/storager/"+silinecekId,
						type: "DELETE",
					    contentType: "application/json",
