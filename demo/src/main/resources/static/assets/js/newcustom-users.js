        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    ...
                    return "<td class='text-center'>"+"<div class=''><div class='col-3'><span class='switch switch-outline switch-icon switch-success'><label><input class=' statusUpdate' mobileNumber='"+mobileNumber+"' type='checkbox' "+statusPrint+" name='select'/><span></span></label></span></div>"+"</td>";
                },
            },{
                field: '_id',
                title: 'Seçenekler',
