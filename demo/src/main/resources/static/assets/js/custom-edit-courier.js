$(document).ready(function() {
	...
	$.ajax({
		url: HOST_URL + "/courier/courier/"+id,
		type: "GET",
					...
					var email = $(".email").val();
					        ...
					        $.ajax({
					            ...
					            success: function (result) {
					                toastr.success('Kurye Güncellendi.', 'İşlem Başarılı', {"progressBar": true,positionClass: "toast-bottom-right",timeOut: 1500})
									setTimeout(function(){   
							        window.location.assign("/dashboard/couriers");
							        }, 1500);
					            },
					            error: function (error) {
							        if(firstName == "" || firstName == null){
										toastr.error('Ad alanı boş geçilemez', 'Hata!', {"progressBar": true,positionClass: "toast-bottom-right",timeOut: 2000})
