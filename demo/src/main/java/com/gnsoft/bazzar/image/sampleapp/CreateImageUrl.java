package com.gnsoft.bazzar.image.sampleapp;
...
import com.gnsoft.bazzar.image.BaseFile;
import com.gnsoft.bazzar.image.Configuration;
import com.gnsoft.bazzar.image.FileCreateRequest;
import com.gnsoft.bazzar.image.FileUpdateRequest;
import com.gnsoft.bazzar.image.ImageKit;
import com.gnsoft.bazzar.image.Result;
import com.gnsoft.bazzar.image.ResultCache;
import com.gnsoft.bazzar.image.ResultCacheStatus;
import com.gnsoft.bazzar.image.ResultFileDelete;
import com.gnsoft.bazzar.image.ResultList;
import com.gnsoft.bazzar.image.ResultMetaData;
...
//        Configuration config = Utils.getSystemConfig(CreateImageUrl.class);
//        imageKit.setConfig(config);
//
////        uploadFromURL();
////        uploadFromBase64();
//       String getUrl= uploadFromBytes("C://Users//gnsof//Downloads//indir.jpg");
//       System.out.println("ÇALIŞTI:"+getUrl);
////
////        calculateDistance();
...
//    }
	...
	public static String generateRandomPathName() {
		 String alphabet = "abcdefghjklmnoprstxyzw1234567890";
    ...
    public static String uploadFromBytes(String path) {
      ...
      //  URL url = App.class.getClassLoader().getResource("sample1.jpg");
        String randomPathName = generateRandomPathName();
        File file=new File(path);
        byte[] bytes= Utils.fileToBytes(file);
        FileCreateRequest fileCreateRequest =new FileCreateRequest(bytes, path.substring(0, 5)+"_"+randomPathName);
        fileCreateRequest.setUseUniqueFileName(false);
        Result result = ImageKit.getInstance().upload(fileCreateRequest);
        System.out.println(">> Uploading done.");
        System.out.println(Color.ANSI_GREEN+">> Response:"+Color.ANSI_RESET);
        System.out.println("sdjskdjksjdksjdks "+result.getUrl());
...
//        String urlEndpoint=ImageKit.getInstance().getConfig().getUrlEndpoint();
    ...
    public static String uploadFromBase64(String base64) {
        ...
        System.out.println(">> Start uploading...");
        URL url = CreateImageUrl.class.getClassLoader().getResource("sample1.jpg");
        File file=new File(url.getPath());
        //String base64= Utils.fileToBase64(file);
        FileCreateRequest fileCreateRequest =new FileCreateRequest(base64, "image.jpg");
        Result result = ImageKit.getInstance().upload(fileCreateRequest);
        System.out.println(">> Uploading done.");
        System.out.println(Color.ANSI_GREEN+">> Response:"+Color.ANSI_RESET);
        System.out.println(result);
